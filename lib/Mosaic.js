...
var MosaicWithoutDragDropContext = exports.MosaicWithoutDragDropContext = /** @class */ (function (_super) {
    ...
    MosaicWithoutDragDropContext.prototype.renderTree = function () {
        ...
        if (root === null || root === undefined) {
            ...
            var renderTile = (_a = this.props, _a.renderTile), resize = _a.resize;
    ...
    MosaicWithoutDragDropContext.prototype.validateTree = function (node) {
        if (process.env.NODE_ENV !== 'production') {
            var keyExtractor = function (n) {
                var key;
                if ((0, isObjectLike_1.default)(n) && n.hasOwnProperty('key')) {
                    key = n.key;
                }
                else {
                    key = n;
            ...
            var duplicates = (0, keys_1.default)((0, pickBy_1.default)((0, countBy_1.default)((0, mosaicUtilities_1.getLeaves)(node), keyExtractor), function (n) { return n > 1; }));
