...
var Split = exports.Split = /** @class */ (function (_super) {
    ...
    Split.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)('mosaic-split', {
                '-row': direction === 'row',
    ...
    Split.prototype.computeStyle = function () {
        var _a, _b;
        var boundingBox = (_a = this.props, _a.boundingBox), direction = _a.direction, splitPercentage = _a.splitPercentage;
        ...
        return __assign(__assign({}, BoundingBox_1.BoundingBox.asStyles(boundingBox)), (_b = {}, _b[positionStyle] = "".concat(absolutePercentage, "%"), _b));
    };
    Split.prototype.calculateRelativePercentage = function (event) {
        var _a;
        var minimumPaneSizePercentage = (_a = this.props, _a.minimumPaneSizePercentage), direction = _a.direction, boundingBox = _a.boundingBox;
