...
var dragSource = {
    beginDrag: function (props, _monitor, component) {
        ...
        var hideTimer = (0, defer_1.default)(function () { return component.context.mosaicActions.hide(component.props.path); });
        return {
...
exports.SourceConnectedInternalMosaicWindow = (0, react_dnd_1.DragSource)(types_1.MosaicDragType.WINDOW, dragSource, function (connect, _monitor) { return ({
    connectDragSource: connect.dragSource(),
    connectDragPreview: connect.dragPreview(),
}); })(InternalMosaicWindow);
exports.SourceDropConnectedInternalMosaicWindow = (0, react_dnd_1.DropTarget)(types_1.MosaicDragType.WINDOW, dropTarget, function (connect, monitor) { return ({
